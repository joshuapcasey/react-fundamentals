        ...
        <div className = 'main'>
            <div className = 'mainDiv'>
                ...
                <dl>
                    ...
                    <dd>These are used to construct and update the DOM, or what you see on your screen.</dd>
                    <dt>Not required</dt>
...
const CreateElementComponent = () => {
    return (
        ...
        React.createElement("p", null, "This was constructed using createElement() in the return"),
